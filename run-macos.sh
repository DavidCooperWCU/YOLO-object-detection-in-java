...
java -Xms1024m -Djava.library.path=$DYLD_LIBRARY_PATH -Djava.io.tmpdir="tmp" -Djdk.gtk.version=2 -Dprism.order=sw -cp build/libs/YOLO-object-detection-in-java-0.3-YOLO.jar --module-path $PATH_TO_FX --add-modules javafx.controls,javafx.fxml,javafx.base sample.yolo 
